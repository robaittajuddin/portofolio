...
if (isset($_POST['btnLogin'])) {
    $konek = mysqli_connect("localhost", "root", "", "logistik"); // Change database to logistik
    if (!$konek) {
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Portal KP</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="" novalidate>
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="txUsername" class="form-control" required>
              ...
              <div class="credits">
                Designed by <a href="https://bootstrapmade.com/">Portal KP</a>
              </div>
