...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-3">
                        ...
                        <a href="kelola_permintaan.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Kelola Permintaan</a>
                        <a href="permintaan_barang.php" class="nav-item nav-link"><i
                        class="fa fa-th me-2"></i>Permintaan Barang</a>
        ...
        <div class="content">
            ...
            <!-- Blank Start -->
            <div class="container">
                <h2 class="my-4 text-center">Kelola Permintaan Barang</h2>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($row['id_permintaan']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['username']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['departemen']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['nama_barang']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['keterangan']) . "</td>"; // Keterangan dari permintaan
                                ...
                                echo "<td>
                                        <button class='btn btn-success' data-id='" . htmlspecialchars($row['id_permintaan']) . "' data-bs-toggle='modal' data-bs-target='#acceptModal'>Terima</button>
                                        <button class='btn btn-danger' data-id='" . htmlspecialchars($row['id_permintaan']) . "' data-bs-toggle='modal' data-bs-target='#rejectModal'>Tolak</button>
                                      </td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='9'>Tidak ada permintaan yang tersedia.</td></tr>";
                        }
                        $conn->close();
                        ?>
                    </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="acceptModalLabel">Terima Permintaan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="acceptForm" method="POST" action="proses_konfirmasi.php">
                    <input type="hidden" id="acceptId" name="id_permintaan">
                    <div class="mb-3">
                        <label for="keteranganTerima" class="form-label">Keterangan Diterima</label>
                        <textarea class="form-control" id="keteranganTerima" name="keterangan" rows="4" placeholder="Masukkan keterangan diterima..." required></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-success" onclick="submitAccept()">Terima</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="rejectModalLabel">Tolak Permintaan</h5 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="rejectForm" method="POST" action="proses_penolakan.php">
                    <input type="hidden" id="rejectId" name="id_permintaan">
                    <div class="mb-3">
        ...
        <!-- Footer End -->
            ...
            <script>
    // Script untuk mengisi ID permintaan ke dalam modal terima
    ...
    // Script untuk mengisi ID permintaan ke dalam modal tolak
