...
<body class="d-flex flex-column min-vh-100">
    <div class="container-fluid position-relative d-flex p-0 flex-grow-1">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <?php if ($role == 'admin'): ?>
                        ...
                        <a href="permintaan_barang.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Permintaan Barang</a>
        ...
        <div class="content flex-grow-1">
            ...
            <div class="container">
                <h2 class="my-4 text-center">Permintaan Barang</h2>
                <form action="proses_permintaan_barang.php" method="post" class="border p-4 rounded bg-light shadow">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="keterangan" name="keterangan" class="form-control" rows="4" placeholder="Masukkan keterangan tambahan..."></textarea>
                    </div>
            ...
            <!-- Form Permintaan Barang End -->

            <div id="statusPermintaan" class="mt-3"></div> <!-- Tempat untuk menampilkan status -->
