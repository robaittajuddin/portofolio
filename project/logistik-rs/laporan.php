<?php
session_start();
if (!isset($_SESSION["ses_username"]) || ($_SESSION["ses_status"] == 'user' && $_SESSION["ses_status"] != 'admin')) {
...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <?php if ($role == 'admin'): ?>
                    ...
                    <a href="laporan.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Laporan</a>   
    ...
    <div class="card mx-auto shadow-lg bg-dark text-white" style="max-width: 600px; outline: 2px solid #333;">
        <div class="card-header bg-danger text-white text-center" style="outline: 2px solid #222;">
            <h3>Cetak Laporan</h3>
        </div>
        <div class="card-body">
            <form action="cetak_laporan.php" method="POST" target="_blank">
                <div class="mb-3">
                    ...
                    <select name="kategori" id="kategori" class="form-select bg-secondary text-white" style="outline: 1px solid #555;">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="start_date" id="start_date" class="form-control bg-secondary text-white" required style="outline: 1px solid #555;">
                </div>
                <div class="mb-3">
                    <label for="end_date" class="form-label">Tanggal Selesai</label>
                    <input type="date" name="end_date" id="end_date" class="form-control bg-secondary text-white" required style="outline: 1px solid #555;">
                </div>
                <div class="mb-3">
                    <label for="tipe_laporan" class="form-label">Tipe Laporan</label>
                    <select name="tipe_laporan" id="tipe_laporan" class="form-select bg-secondary text-white" style="outline: 1px solid #555;">
                        <option value="barang">Laporan Barang</option>
                        <option value="permintaan">Laporan Permintaan Barang</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="format_file" class="form-label">Format File</label>
                    <select name="format_file" id="format_file" class="form-select bg-secondary text-white" style="outline: 1px solid #555;">
                        <!-- <option value="excel">Excel</option> -->
                        <option value="pdf">PDF</option>
                    </select>
                </div>
                <button type="submit" class="btn btn-danger w-100" style="outline: 2px solid #770000;">Cetak Laporan</button>
            </form>
        </div>
    </div>
</div>
